...
def main():
    ...
    print(modbus.read_input_register_formatted(register_addr = 33079, quantity = 2, signed = 1))

    """Query single holding register, apply bitmask and bitshift left (extract bit1 from register)"""
    print(modbus.read_holding_register_formatted(register_addr = 43110, quantity = 1, bitmask = 0x2, bitshift = 1))
